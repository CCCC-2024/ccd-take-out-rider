<template>
  <view class="zhi_binding">
    <view class="content">
      <!-- <view class="updata ident">
        ...
        <view class="verific">
          <view class="verific-left">
            <text>验证码</text>
            <input type="number" value="" placeholder="请输入验证码" v-model="vercode" @blur="verificationCode" />
          </view>
      ...
      <view class="updata ident">
        <view class="updata_text">第一步：支付宝账号</view>
        <view class="">
          <input type="text" value="" placeholder="请填写支付宝账号"v-model="accountNum" />
        </view>
      ...
      <view class="inp_ ident">
        <view class="updata_text">第二步：填写支付宝真实姓名</view>
        <view class="nameMsg">
          <view>真实姓名</view>
    ...
    <view class="sure" @click="addZhi()">提交</view>
  </view>
</template>
<script>
    ...
    methods: {
      ...
      addZhi() {
        ...
        setTimeout(function(){
          ...
          if (that.nickname == '' || that.accountNum == '') {
