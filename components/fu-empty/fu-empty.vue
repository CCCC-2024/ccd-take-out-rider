<template>
  <view>
    <view class="loading-wapper" v-if="!pagingListLoadedAll && !pagingListNoListData">
      ...
      <text class="loading-txt">{{LANGUAGE_DATA['加载中'][LANGUAGE]}}</text>
    </view>
    <view class="loading-wapper" v-if="pagingListLoadedAll && !pagingListNoListData && listDataLength != 0">
      <text class="loading-txt">{{LANGUAGE_DATA[pagingListLoadedAllText][LANGUAGE]}}</text>
    </view>
    <view class="public-page-empty" v-if="(pagingListLoadedAll && pagingListNoListData) || (pagingListLoadedAll && listDataLength == 0)">
      ...
      <view class="txt">{{LANGUAGE_DATA[pagingListNoListDataText][LANGUAGE]}}</view>
    </view>
  </view>
</template>
...
export default {
  ...
  created() {
    ...
    uni.$on('LANGUAGE_SETTING_SUCCESS', res => {
      this.LANGUAGE = global.LANGUAGE
    })
  }
}
